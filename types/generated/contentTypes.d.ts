...
export interface ApiCompanionCompanion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    comp_status: Schema.Attribute.Enumeration<
...
export interface ApiDisabilityCardDisabilityCard
  ...
  attributes: {
    ...
    file: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required;
    issuing_card: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    max_cap: Schema.Attribute.BigInteger &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    seat_maps: Schema.Attribute.Media<
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contact_data: Schema.Attribute.Component<'contact.contact-data', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
...
export interface ApiOrganizerOrganizer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contact_data: Schema.Attribute.Component<'contact.contact-data', true> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    type: Schema.Attribute.Enumeration<
      ['Corporate', 'Social', 'Festival', 'Conference', 'Nightlife']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ticket_status: Schema.Attribute.Enumeration<['Available', 'Not available']>;
    ticket_type: Schema.Attribute.Enumeration<['Companion', 'Disability']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    prim_language: Schema.Attribute.Enumeration<['German', 'English']>;
